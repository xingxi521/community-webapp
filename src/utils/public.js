 ...
 * @param {(string)} title
 */
export const notifiySuccess = function (message, duration) {
  Notify({
    type: 'success',
 ...
 * @param {(string)} title
 */
export const notifiyWarning = function (message, duration) {
  Notify({
    type: 'warning',
    duration: duration || 3000,
    message
 ...
 * @param {(string)} title
 */
export const notifiyError = function (message, duration) {
  Notify({
    type: 'danger',
    duration: duration || 3000,
    message
...
export const confirmBox = async function(message, opt = {}) {
  ...
  await Dialog.confirm(option).then(action => {
