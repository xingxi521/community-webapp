  ...
  <div class="comment-item-main">
    ...
    <div class="comment-bottom">
      ...
      <div class="comment-bottom-right">
        <span v-if="postData.isEnd !== 1" class="edit" @click="editHandler(item)">编辑</span>
        <span v-if="postData.isEnd !== 1" class="del" @click="delCommentHandler(item)">删除</span>
        <span v-if="postData.isEnd !== 1" class="accept" @click="acceptHandler(item)">采纳</span>
      </div>
    </div>
    <!-- 回复盖楼 -->
